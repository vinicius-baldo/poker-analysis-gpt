...
class GUI:
    ...
    def __init__(self, game_state, poker_assistant):
        ...
        possible_titles = [
            ...
            "5234234655",
            "664544545211",
            "343242343256, 2443243252532, 55525, 65465345",
        ]
    ...
    def add_widgets(self):
        ...
        tableFont = tkFont.Font(
            family="Lucida Grande", size=14
        )  # Font for Treeview elements
        ...
        for col in self.player_tree["columns"]:
            ...
            self.player_tree.column(
                col, width=140, anchor="center"
            )  # You can adjust the width as necessary
        ...
        self.log_info = scrolledtext.ScrolledText(
            self.root, height=8, width=80, bg="#171821", fg="white", font=self.fontStyle
        )
        self.log_info.grid(row=8, column=0, columnspan=5, pady=10, padx=10, sticky="nw")

        # Log Entries and its ScrolledText field
        self.ai_log_info = scrolledtext.ScrolledText(
            self.root,
            height=10,
            width=80,
            bg="#171821",
        ...
        self.ai_log_info.grid(
            row=9, column=0, columnspan=5, pady=10, padx=10, sticky="nw"
        )
        ...
        for player_number in sorted_player_numbers:
            ...
            self.player_tree.insert(
                ...
                values=(
                    player_info.get(
                        "name", "N/A"
                    ),  # Replace 'N/A' with your default values or checks
